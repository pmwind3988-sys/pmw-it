...
/**
 * Read a freshly parsed sheet into a plan for the screen.
 *
 * There is no "should we read it" flag. Reading the written answers is
 * what this section is for, so a sheet that has one gets it read; the
 * only decision left is WHICH column, and that is `analyseColumn`.
 */
