...
/** Horizontal bars. Rows carrying an `onClick` become the way into their slice. */
function BarChart({ title, blurb, rows, onSelect, emptyText }) {
...
function ColumnChart({ title, blurb, columns }) {
